...
def train(train_A_dir, train_B_dir, model_dir, model_name, random_seed, validation_A_dir, validation_B_dir, output_dir, tensorboard_log_dir):
    ...
    model = CycleFlowGAN(batch_size = mini_batch_size, num_features = num_mcep, frames=n_frames)
    ...
    for epoch in range(num_epochs):
        ...
        for i in range(n_samples // mini_batch_size):
            ...
            generator_loss, discriminator_loss = model.train(input_A = dataset_A[start:end], input_B = dataset_B[start:end], generator_learning_rate = generator_learning_rate, discriminator_learning_rate = discriminator_learning_rate)
